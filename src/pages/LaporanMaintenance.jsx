    ...
    <Layout>
      <div>
        <div className="md:px-8 px-6 md:py-4 py-8">
          <div className="flex items-center justify-between md:mb6 mb-8">
            <BackButton />
                ...
                <tr className="even:bg-gray-200 text-center font-semibold text-slate-900">
                  ...
                  <td className="py-4">
                    <Button
                      ...
                      path="/laporan/laporandmaintenance/detaillaporanmaintenance"
                    />
                  </td>
                </tr>
          ...
          <div id="card" className="md:hidden">
            ...
            <DetailCard
              ...
              to="/laporan/laporandmaintenance/detaillaporanmaintenance"
            />
            <DetailCard
...
export default LaporanMaintenance;
