        ...
        <div className="md:px-8 px-6 md:py-4 py-8">
                ...
                <tr className="even:bg-gray-200 text-center font-semibold text-slate-900">
                  ...
                  <td className="py-4">
                    <Button
                      ...
                      path="/laporan/laporandfinishing/detaillaporanfinishing"
                    />
                  </td>
                </tr>
          ...
          <div id="card" className="md:hidden">
            ...
            <DetailCard
              ...
              to="/laporan/laporandfinishing/detaillaporanfinishing"
            />
            <DetailCard
...
export default LaporanFinishing;
